...
public class OpenMeteoAdapter {
    ...
    private static final long   POLL_INTERVAL = 1000L; // 1 minute
    private static final long[] serialCounters = new long[LOCATIONS.length];
    ...
    private static KafkaProducer<String, String> buildProducer() {
        ...
        props.setProperty(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG,
                StringSerializer.class.getName());
        // Idempotent delivery — avoids duplicates on transient network errors
