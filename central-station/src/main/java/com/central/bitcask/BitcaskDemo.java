...
/**
 * Standalone BitCask smoke test — no Kafka. Seeds keys, reads them back, then
 * exits.
...
public class BitcaskDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] keys = { "station_id:1", "station_id:1", "station_id:1" };
        for (String key : keys) {
        ...
        for (String key : keys) {
            ...
            System.out.println(
                    "[GET] " + key + " -> " + (val == null ? "null" : new String(val, StandardCharsets.UTF_8)));
        }
